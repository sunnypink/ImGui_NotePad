...
{
    ImGui::SetNextWindowSize(ImVec2(500, 300), ImGuiCond_None);
    ...
    m_ImGui_ReadDirectoryList(m_dir_info);

    //path = m_dir_info.current_directory_path.c_str();
	//m_ImGui_SelectDirectoryPath(static_cast<char *>(m_dir_info.current_directory_path.c_str());
...
void ImGui_FileExplore::m_ImGui_ReadDirectoryList(directory_Info &dir_info)
{

	/*1. read current directory used ${PWD}*/
	dir_info.current_directory_path = std::filesystem::current_path();
...
#if 0
	  fs::path directory_path("/home/sunny/");
