...
namespace ImGui
{
    ...
    IMGUI_API void          ShowDemoWindow(const char* name, bool* p_open = NULL);        // create Demo window. demonstrate most ImGui features. call this to learn about the library! try to make it always available in your application!
